	...
	<div id="agenda">
		<?php
			...
			if (isset($_POST["guardarevento"])=="Si")
			{
				...
				pg_dbname($dbname);
				if ($r1=pg_query($q1)) $mostrar="<p class='ok' id='mensaje'>Evento guardado correctamente.</p>";
			...
			if (isset($_GET["borrarevento"]))
			{
				...
				pg_dbname($dbname);
				if ($r1=pg_query($q1)) $mostrar="<p class='ok' id='mensaje'>Evento eliminado correctamente.</p>";
			...
			if (isset($_POST["addevent"])=="Si")
			{
				...
				pg_dbname($dbname);
				if ($r1=pg_query($q1))
				$mostrar="<p class='ok' id='mensaje'>Evento guardado correctamente.</p>";				
